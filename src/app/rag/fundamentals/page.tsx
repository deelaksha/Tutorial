...
The model SHOULD say 28, but it CAN'T — it doesn't have access. 🖨`}
        ...
        <Callout type="mistake">
          ⚠️ <strong>Hallucination = confident wrongness</strong>. The LLM doesn&apos;t say &quot;I don&apos;t know.&quot; It generates a fluent, confident answer that SOUNDS right but is factually wrong. This breaks trust. Users assume it&apos;s correct. RAG fixes this by grounding answers in YOUR real docs.
        </Callout>
        <P>
...
Scores: [2, 2, 0] → Doc 0 retrieved ✅`}
        ...
        <Callout type="mistake">
          ⚠️ <strong>Keyword overlap FAILS on paraphrases</strong>. If the user asks &quot;How long can it fly?&quot; (different words, same meaning), this retriever scores 0 overlap with Doc 0. It would fail. <strong>Embeddings fix this</strong> — they capture meaning, not just keywords. Chapter 3 covers embeddings.
        </Callout>
        <P>
      ...
      <Section id="misconceptions" number="11" title="Common Misconceptions">
        <Callout type="mistake">
          ⚠️ <strong>Misconception 1: &quot;RAG retrains the LLM on my data.&quot;</strong>
        </Callout>
        <P>
        ...
        <Callout type="mistake">
          ⚠️ <strong>Misconception 3: &quot;RAG eliminates hallucination.&quot;</strong>
        </Callout>
        <P>
        ...
        <Callout type="mistake">
          ⚠️ <strong>Misconception 4: &quot;Embeddings are just word counts.&quot;</strong>
        </Callout>
        <P>
