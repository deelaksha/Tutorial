...
const LANGUAGES = [
  ...
  },
  {
    ...
    name: "Go",
    icon: "🐹",
    tagline: "Concurrency · Backend · Cloud-native",
    desc: "From hello world to a production REST API: slices, interfaces, goroutines and channels — every concept on a live 3D animated diagram you can play, pause and step through.",
    href: "/golang",
    available: true,
    modules: "12 topics · live diagrams",
    glow: "hover:shadow-[0_0_60px_-15px_rgba(34,211,238,0.6)]",
    ring: "border-cyan-700/50",
    badge: "bg-emerald-950/60 border-emerald-700/50 text-emerald-300",
  },
  {
    ...
    name: "Jenkins",
    icon: "🎩",
    tagline: "CI/CD · Pipelines · Automation",
    desc: "CI/CD end to end: freestyle jobs → Jenkinsfiles → agents → a full production pipeline with approval gates and auto-rollback — every build animated step by step.",
    href: "/jenkins",
    available: true,
    modules: "8 topics · live pipelines",
    glow: "hover:shadow-[0_0_60px_-15px_rgba(248,113,113,0.6)]",
  ...
  },
  {
    ...
    name: "Kubernetes",
    icon: "☸️",
    tagline: "Orchestration · Pods · GitOps",
    desc: "The detailed K8s course: architecture, pods, deployments, services, ingress, storage, RBAC, Helm and GitOps — every control loop drawn live, ending with a production capstone.",
    href: "/kubernetes",
    available: true,
    modules: "12 topics · in depth",
    glow: "hover:shadow-[0_0_60px_-15px_rgba(96,165,250,0.6)]",
    ring: "border-blue-700/50",
    badge: "bg-emerald-950/60 border-emerald-700/50 text-emerald-300",
  },
  {
    id: "sonic",
    name: "SONiC",
    icon: "🦔",
    tagline: "NOS · Mgmt Framework · Redis · YANG",
    desc: "The open-source switch OS dissected: Redis DBs, YANG/OpenConfig, CVL, Transformer, Translib, hostcfgd & Jinja — one NTP request traced through all nine hops, then build your own feature.",
    href: "/sonic",
    available: true,
    modules: "19 topics · full course",
    glow: "hover:shadow-[0_0_60px_-15px_rgba(251,191,36,0.6)]",
  ...
  },
  {
    ...
    name: "RAG & LangChain",
    icon: "🦜",
    tagline: "LLMs · Embeddings · Vector DBs · Agents",
    desc: "Build a real docs chatbot from scratch: embeddings, vector stores, LCEL chains, retrievers, memory, agents, evaluation and FastAPI deployment — one project, NimbusBot, carried through all 14 topics.",
    href: "/rag",
    available: true,
    modules: "14 topics · full course",
    glow: "hover:shadow-[0_0_60px_-15px_rgba(244,114,182,0.6)]",
    ring: "border-pink-700/50",
    badge: "bg-emerald-950/60 border-emerald-700/50 text-emerald-300",
  },
